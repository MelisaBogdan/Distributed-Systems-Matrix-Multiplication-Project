...
// 	deadline based scaling
		...
		// Different channels for each AWS 
                ManagedChannel channel1 = ManagedChannelBuilder.forAddress(aws1,  9091).usePlaintext().build();  
                ManagedChannel channel2 = ManagedChannelBuilder.forAddress(aws2,  9091).usePlaintext().build();  
                ManagedChannel channel3 = ManagedChannelBuilder.forAddress(aws3,  9091).usePlaintext().build();  
                ManagedChannel channel4 = ManagedChannelBuilder.forAddress(aws4,  9091).usePlaintext().build();  
                ManagedChannel channel5 = ManagedChannelBuilder.forAddress(aws5,  9091).usePlaintext().build();  
                ManagedChannel channel6 = ManagedChannelBuilder.forAddress(aws6,  9091).usePlaintext().build();  
                ManagedChannel channel7 = ManagedChannelBuilder.forAddress(aws7,  9091).usePlaintext().build();  
                ManagedChannel channel8 = ManagedChannelBuilder.forAddress(aws8,  9091).usePlaintext().build(); 
